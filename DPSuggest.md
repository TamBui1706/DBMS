...
| **Medium** | **Transaction Lifecycle** | **State** | Manages Transaction states (Active, Committed, Aborted) and changes behavior accordingly. |
| **High** | **SQL Evaluation** | **Interpreter** | Evaluates SQL conditions (AST) by interpreting nodes against row data. |
