    ...
    if request.method == "GET":
        ...
        if serializer.is_valid():
            return Response({
                ...
                "categoryId": serializer.validated_data.get("categoryId", ""),
                "type": serializer.validated_data.get("type", "Physical"),
                "stockStatus": serializer.validated_data.get("stockStatus", "InStock"),
                "images": []
...
def product_detail(request, productId):
    if request.method == "GET":
        ...
        if serializer.is_valid():
            return Response({
                "id": productId,
                "name": serializer.validated_data.get("name", "Design System Pro Kit"),
                "price": serializer.validated_data.get("price", 99.0),
                "categoryId": "cat_ui",
                "type": "Digital",
                "stockStatus": serializer.validated_data.get("stockStatus", "InStock"),
                "images": []
